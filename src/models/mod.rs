...
pub mod alternative_title;
pub use self::alternative_title::AlternativeTitle;
...
pub use self::movie_collection::MovieCollection;
...
pub use self::movie_metadata::MovieMetadata;
...
pub mod movie_translation;
pub use self::movie_translation::MovieTranslation;
